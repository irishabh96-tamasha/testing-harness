...
- [PR #22](https://github.com/tamasha-live/mobile-app/pull/22) -- Implementation PR
- [WOR-540](https://linear.app/tamasha/issue/WOR-540) -- Epic ticket

---

*This upgrade guide is part of the [MOB SAFe Agentic Workflow](https://github.com/tamasha-live/mobile-app) harness.*
