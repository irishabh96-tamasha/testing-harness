...
-- 5. Create RLS policy for superuser (app_user)
...
-- 6. Create RLS policy for application user (tamasha_app_user)
...
- 2025-10-03: Created table with RLS policies [MOB-300]
```
...
# Test user isolation
psql -U tamasha_app_user -d app_dev \
