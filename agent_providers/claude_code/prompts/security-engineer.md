...
cat scripts/rls-phase4-final-validation.sql | docker exec -i tamasha-team-postgres-1 psql -U tamasha_app_user -d app_dev && npm audit --audit-level=high && yarn lint && echo "SECURITY SUCCESS" || echo "SECURITY FAILED"
```
